 ...
 * @author jrmac
 */
@WebServlet(name = "SubtractionServlet", urlPatterns = {"/sub.html"})
public class SubtractionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServerDataServlet</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                double result = (n1 - n2);
                out.println("<h3>A subtração de " + n1 + " - " + n2 + " é igual a " + result + "</h3>");
            } catch (Exception e) {
